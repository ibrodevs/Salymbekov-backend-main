...
from .models import ItCollegePage


@admin.register(ItCollegePage)
class ItCollegePageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "program_family",
        "program_level",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=ItCollegePage.objects.values("pk"))
