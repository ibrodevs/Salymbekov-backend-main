...
from .models import PostgradPage


@admin.register(PostgradPage)
class PostgradPageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "program_family",
        "program_level",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=PostgradPage.objects.values("pk"))
