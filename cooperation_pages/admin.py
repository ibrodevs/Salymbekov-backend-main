...
from .models import CooperationPage


@admin.register(CooperationPage)
class CooperationPageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "about_section",
        "path",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=CooperationPage.objects.values("pk"))
