...
from .models import MfmPage


@admin.register(MfmPage)
class MfmPageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "program_family",
        "program_level",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=MfmPage.objects.values("pk"))
