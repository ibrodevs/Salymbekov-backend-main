...
from .models import AitPage


@admin.register(AitPage)
class AitPageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "program_family",
        "program_level",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=AitPage.objects.values("pk"))
