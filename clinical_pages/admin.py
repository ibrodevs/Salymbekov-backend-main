...
from .models import ClinicalPage


@admin.register(ClinicalPage)
class ClinicalPageAdmin(BaseCmsPageAdmin):
    list_display = [
        "admin_title",
        "about_section",
        "path",
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).filter(pk__in=ClinicalPage.objects.values("pk"))
